...
struct CA_Configuration_S MASB_COMM_S_getCaConfiguration(void) { // cronoamperometría
	...
	struct CA_Configuration_S caConfiguration;
	  	...
	  	caConfiguration.eBegin = saveByteArrayAsLongFromBuffer(rxBufferDecoded, 1);
	  	caConfiguration.eVertex1 = saveByteArrayAsLongFromBuffer(rxBufferDecoded, 9);
	  	caConfiguration.eVertex2 = saveByteArrayAsLongFromBuffer(rxBufferDecoded, 17);
	  	caConfiguration.cycles = rxBufferDecoded[25];
	  	caConfiguration.scanRate = saveByteArrayAsLongFromBuffer(rxBufferDecoded, 26);
	  	caConfiguration.eStep = saveByteArrayAsLongFromBuffer(rxBufferDecoded, 34);
